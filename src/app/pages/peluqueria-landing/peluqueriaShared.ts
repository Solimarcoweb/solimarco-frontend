...
/** Multi-tenant theme for the hairdresser sector. */
export const PELUQUERIA_THEME = 'mediterraneo'

/** Base path of the multi-page peluqueria site. */
export const PELUQUERIA_BASE_PATH = '/peluqueria-multi'
...
/**
 * Builds schema.org `HairSalon` structured data from the tenant config.
 *
 * @param config - Resolved tenant configuration.
 * @param url - Canonical page URL.
 * @returns A JSON-LD object for the hair salon.
 */
export function buildHairSalonSchema(config: TenantConfig, url: string): Record<string, unknown> {
  return {
