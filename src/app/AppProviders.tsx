 ...
 * per-page SEO tags), i18n scoped to a single instance per tenant, and the
 * `TenantProvider` which resolves tenant configuration from the backend and
 * applies the matching theme to the document.
 ...
 * @param props.defaultLocale - Tenant's default UI locale; overridden by the
 * tenant configuration once it loads from the backend.
 */
