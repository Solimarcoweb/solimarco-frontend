...
import { PELUQUERIA_THEME, LEGAL_LINKS, buildHairSalonSchema } from './peluqueriaShared'

/**
 * Single-page (landing) hairdresser template, driven by tenant data:
...
export default function PeluqueriaLandingPage() {
  ...
  return (
    <>
      ...
      />
      <SharedJsonLd schema={buildHairSalonSchema(config, canonicalUrl)} />
